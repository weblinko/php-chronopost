...
class ShippingMultiParcelV2 extends AbstractStructBase
{
     ...
     * @return \Chronopost\StructType\SkybillWithDimensionsValueV4[]|null
     */
     ...
     * @return \Chronopost\StructType\ShippingMultiParcelV2
     */
    public function addToSkybillValue(\Chronopost\StructType\SkybillWithDimensionsValueV4 $item)
    {
        // validation for constraint: itemType
     ...
     * @return \Chronopost\StructType\RecipientLocalValue[]|null
     */
     ...
     * @return \Chronopost\StructType\ShippingMultiParcelV2
     */
    public function addToRecipientLocalValue(\Chronopost\StructType\RecipientLocalValue $item)
    {
        // validation for constraint: itemType
